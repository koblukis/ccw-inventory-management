...
> Sourced from [`beck-source/inventory-management`](https://github.com/beck-source/inventory-management/tree/main). This repository is a copy maintained for instructional use.
